/**
 * Tests the methods of the Notation class
 *  @author Paul Dacey
 */
...
public class NotationTest {
	...
	/**
	 * Resets variables for next test
	 * @throws Exception Throws exception if error occurs
	 */
	@After
	...
	/**
	 * Tests convertInfixToPostfix
	 * @throws InvalidNotationFormatException Used to catch InvalidNotationFormatException
	 */
	@Test
	...
	/**
	 * Tests convertPostfixToInfix method
	 * @throws InvalidNotationFormatException Used to catch InvalidNotationFormatException
	 */
	@Test
	...
	/**
	 * Tests evaluatePostfixExpression
	 * @throws InvalidNotationFormatException Used to catch InvalidNotationFormatException
	 */
	@Test
	...
	/**
	 * Tests if evaluatePostfixExpression throws an exception
	 * 
	 */
	@Test
